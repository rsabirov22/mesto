...
export const formConfirmDelete = popupConfirm.querySelector('.popup__form_confirm');
export const confirmDeleteCardBtn = formConfirmDelete.querySelector('#confirm-submit');
